...
$(function() {
  ...
  widgetType.change(function() {
    ...
    if (widgetType.val() === "2" ) {
      inputs.forEach(function(input) { input.css({visibility: 'hidden', position: 'absolute', top: '-1000px' }); });
    } else {
      inputs.forEach(function(input) { input.css({visibility: 'visible', position: 'inherit', top: '0' }); });
    }
  });
});